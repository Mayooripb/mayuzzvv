...
<html lang="en">
  ...
  <body>
	...
	<div class="header">
			...
			<ul><h3 style="padding-left: 350px;color: green">REGISTERDE DONOR'S</h3></ul>
	...
	<?php
			$sts="Registered";
			$q="select * from donarregistration where STATUS='$sts'";
			$p=mysql_query($q);
			...
			<table border="2" class="table">
				<tr><th>DONAR ID</th><th>REGISTRATION DATE</th><th>DONARNAME</th><th>BLOOD GROUP</th><th>ADDRESS</th><th>CONTACT</th><th>AGE</th><th>HEIGHT</th><th>WEIGHT</th></tr>
				<?php
