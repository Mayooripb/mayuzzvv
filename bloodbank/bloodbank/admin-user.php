...
<html lang="en">
  ...
  <body>
	...
	<div class="header">
			...
			<ul><h3 style="padding-left: 500px;color: green">USER DETAILS</h3></ul>
	...
	<?php
			$sts="Registered";
			$q="select * from registration where STATUS='$sts'";
			$p=mysql_query($q);
			...
			<table border="2" class="table">
				<tr><th>ID</th><th>NAME</th><th>GENDER</th><th>ADDRESS</th><th>CONTACT</th><th>DISTRICT</th><th>EMAIL</th></tr>
				<?php
